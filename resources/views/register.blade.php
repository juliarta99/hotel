                ...
                <form class="mt-5" action="/register" method="post">
                  @csrf
                    <div class="mb-3">
                      ...
                      <input type="text" name="name" class="form-control @error('name') border border-1 border-danger @enderror" id="name" aria-describedby="emailHelp">
                      @error('name')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" name="email" class="form-control @error('email') border border-1 border-danger @enderror" id="exampleInputEmail1" aria-describedby="emailHelp">
                      @error('email')
                        <p class="text-danger">{{ $message }}</p>
                      @enderror
                    </div>
